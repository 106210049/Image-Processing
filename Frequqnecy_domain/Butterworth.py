...
f1=np.fft.fft2(I_filtered_by_butterworth)
...
plt.subplot(2, 2, 2) 
plt.imshow(I_filtered_by_butterworth, cmap="gray"), plt.title("butterworth filter"), 
plt.axis("off"), plt.xticks([]), plt.yticks([]) 
plt.subplot(2, 2, 3) 
plt.imshow(magnitude_spectrum1, cmap="gray"), plt.title("magnitude spectrum 1 butterworth filter"), plt.axis("off"), plt.xticks([]), plt.yticks([]) 
plt.subplot(2, 2, 4) 
