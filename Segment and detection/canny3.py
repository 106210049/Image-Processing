...
def canny_edge_detection(gray, sigma=1, kernel_size=5, low_threshold=50, high_threshold=100):
    ...
    return edges
image = cv2.imread("D:\Python_CV\Segment and detection\clb.png",0)
...
### Cuối kì mỗi nhóm chuẩn bị 1 phương pháp segmentation: Giải thuật, dữ liệu, kết quả rõ ràng, đánh giá kết quả.
### Phương pháp : deep learning (Neural network): Đây cũng là 1 phương pháp để thực hiện bài toán Segmentation
# + Báo cáo có mô hình thì cần phải test vài chục hình, mô tả cụ thể mô hình đó.
